...
export async function GetListOfStudentsController(req: Request, res: Response) {
...
export const GetListOfAssignmentsByStudent = async (req: Request, res: Response) => {
    try {
        const {id} = req.params;
        if (!isUUID(id)) {
            return res.status(400).json({
...
export const GetListOfStudentGrades = async (req: Request, res: Response) => {
    try {
        const {id} = req.params;
        if (!isUUID(id)) {
            return res.status(400).json({
